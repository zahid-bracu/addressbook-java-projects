...
public class RegisterForm extends javax.swing.JFrame {
    ...
    public RegisterForm() {
        initComponents();
        /*navigator-->jframe-->set layout-->free design-->properties-->undecorated
        makes the borderless and clear window
        only the application will be shown*/
        /*for keep the application window at the center of the desktop*/
    ...
    private void RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterActionPerformed
         ...
         /*gettings input from the form's text field into the codes variable*/ 
         ...
         if(flag==true)
         {
             ...
             ResultSet rs2;
             String query2= "SELECT * FROM `registration` WHERE `mail` =? ";
             ...
             try
             {
                 ...
                 else if(rs2.next())
                 {
                     ...
                     JOptionPane.showMessageDialog(null,"mail not available");
                 }
                 ...
                 {
                     JOptionPane.showMessageDialog(null, "Password length is less then 7");
                 }
